...
public class NewUserGraph {
    ...
    private static final Color CHART_BLUE = new Color(0x3498DB);
    private static final Color CHART_HOVER = new Color(0x2980B9);
    ...
    public static void chooseYear() {
        SwingUtilities.invokeLater(() -> {
            ...
            JFrame frame = new JFrame("New User Registration Graph - Admin Panel");
    ...
    private static JPanel createHeaderPanel() {
        ...
        // Title
        JLabel titleLabel = new JLabel("New User Registration Analytics");
    ...
    private static JPanel createFooterPanel() {
        ...
        JLabel footerLabel = new JLabel("Registration Analytics • Data Source: User Database • Updated: Real-time");
    ...
    private static class BarChartPanel extends JPanel {
        private int[] monthlyData = {45, 52, 48, 67, 89, 112, 156, 143, 128, 95, 73, 58}; // Sample data
        ...
        protected void paintComponent(Graphics g) {
            ...
            // Draw axes với màu sắc hiện đại
            ...
            g2d.setColor(DARK_BLUE);
            String title = "NEW USER REGISTRATIONS - " + currentYear;
            int titleWidth = g2d.getFontMetrics().stringWidth(title);
            g2d.drawString(title, width/2 - titleWidth/2, margin - 20);

            // Y axis label
            g2d.rotate(-Math.PI / 2);
            g2d.drawString("Number of Registrations", -height/2 - 50, margin - 45);
            g2d.rotate(Math.PI / 2);
